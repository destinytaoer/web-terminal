...
export const ENCODELIB = {
   ...
   */
  pack_u16_be: function pack_u16_be(number: number) {
   ...
   * @returns {number[]} The octet values.
   */
  pack_u32_le: function pack_u32_le(number: number) {
   ...
   */
  unpack_u16_be: function unpack_u16_be(bytes_arr: Octets) {
   ...
   * @returns {number} The decoded number.
   */
  unpack_u32_le: function unpack_u32_le(octets: Octets) {
   ...
   */
  octets_to_hex: function octets_to_hex(octets: Octets) {
    const hex = []
   ...
   */
  parse_hex_octets: function parse_hex_octets(hex_octets: Octets) {
    const octets = new Array(hex_octets.length / 2)
